...
public class ReflectingActivity : Activity
{
    ...
    // A list of indexes of what questions has already been displayed to the user.
    private List<int> _questionIndexes = new List<int>();

    private int _endOfQuestionList = 0;
    ...
    public string GetRandomQuestion()
    {
        ...
        else
        {
            ...
            do{
                // Check if the index for the question list has already been used.
                ...
                {
                    _questionIndexes.Add(questionIndex);
                    isDuplicateQuestion = false;
                }

            }while (isDuplicateQuestion == true);
